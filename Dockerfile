...
RUN touch ~/.bashrc && wget -qO- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.4/install.sh | bash && export NVM_DIR="$HOME/.nvm" && source $NVM_DIR/nvm.sh && nvm install 16.19.1 && nvm use 16.19.1
